...
const seed = async () => {
    await prisma.User
      .createMany({ data: user, skipDuplicates: true })
      .then((response) => {
        console.log("users seeded  ", response);
      })
      await prisma.Game
      .createMany({ data: games, skipDuplicates: true })
      .then((response) => {
        console.log("games seeded  ", response);
      })
      await prisma.Order
      .createMany({ data: orders, skipDuplicates: true })
      .then((response) => {
      ...
      await prisma.FavorisList
      .createMany({ data: favorite, skipDuplicates: true })
      .then((response) => {
        console.log("favorisList seeded  ", response);
      })
      await prisma.Review
      .createMany({ data: review, skipDuplicates: true })
      .then((response) => {
      ...
      await prisma.Tag
      .createMany({ data: tags, skipDuplicates: true })
      .then((response) => {
        console.log(" tags seeded  ", response);
      })
      ...
      .createMany({ data: transactions, skipDuplicates: true })
      .then((response) => {
        console.log("Transactions seeded  ", response);
      })
      await prisma.GameKey
      .createMany({ data: gamekeys, skipDuplicates: true })
      .then((response) => {
        console.log("gamekeys seeded  ", response);
      })
      await prisma.UserProfile
      .createMany({ data: userprofiles, skipDuplicates: true })
      .then((response) => {
      ...
      .createMany({ data: subscription, skipDuplicates: true })
      .then((response) => {
        console.log("Subscriptions seeded  ", response);
      })
      await prisma.Discount
      .createMany({ data: discounts, skipDuplicates: true })
      .then((response) => {
 ...
 console.log("data seeded ye si zeby ")
